...
##Genotype Plots
# Clean column names: keep only the filename part, not full paths
clean_names <- function(names_vec) {
  return(basename(gsub("\\\\", "/", names_vec)))  # convert backslashes to slashes, then strip path
}
...
#review 
print(sampleFails)
print(sampleContaminant)
print(sampleWrongSpp)
#all problem samples combined
print(sampleBlacklist)
